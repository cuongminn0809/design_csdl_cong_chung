...
let notifications: MyNotification[] = [
  { id: "tb-01", title: "Bảo trì hệ thống ngày 05/08/2026", type: "Thông báo hệ thống", priority: "Cao", source: "Hệ thống", receivedAt: "2026-08-28T08:50:00", read: false, content: "Hệ thống tạm dừng phục vụ từ 22:00 ngày 05/08/2026 đến 02:00 ngày 06/08/2026 để nâng cấp hạ tầng. Đề nghị người dùng hoàn tất thao tác trước thời điểm trên.", attachments: [], deleted: false },
